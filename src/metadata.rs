...
pub struct Meta {
    /// Theme name selected for the deck.
    #[serde(default = "Meta::default_theme")]
    pub theme: String,
    /// Deck author shown in metadata-aware contexts.
    #[serde(default = "Meta::default_author")]
    pub author: String,
    /// Deck date as supplied by front matter or generated by default.
    #[serde(default = "Meta::default_date")]
    pub date: String,
    /// Paging format string for slide counters.
...
impl Meta {
    /// Create metadata with all default values applied.
    pub fn new() -> Self {
        Self::default()
    }
